...
export const HeaderMain = (props: HeaderMainProps) => {
  const { userId } = props;
  ...
  return (
    <div className="flex justify-between items-center">
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DropdownMenu open={openDropdown} onOpenChange={setOpenDrodown}>
        ...
        <DialogContent className="sm:max-w-[825px] ">
          <DialogHeader>
            <DialogTitle>
              <DialogDescription>Nuevo elemento</DialogDescription>
            </DialogTitle>
          </DialogHeader>
