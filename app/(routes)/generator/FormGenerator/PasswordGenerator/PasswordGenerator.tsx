    ...
    <>
      ...
      <div>
        <div className="flex items-center space-x-2 my-4 bg-slate-100 rounded-md shadow-md p-4 ">
          ...
          />
          <label htmlFor="mayus" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-aria-disabled:opacity-70">
            Mayusculas A-Z
          </label>
        </div> 
        ...
        <div className="flex items-center space-x-2 my-4 bg-slate-100 rounded-md shadow-md p-4 ">
          ...
          />
          <label htmlFor="minus" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-aria-disabled:opacity-70">
            Minusculas a-z
          </label>
        ...
        <div className="flex items-center space-x-2 my-4 bg-slate-100 rounded-md shadow-md p-4 ">
          ...
          />
          <label htmlFor="numbers" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-aria-disabled:opacity-70">
            Numbers 0-9
          </label>
        ...
        <div className="flex items-center space-x-2 my-4 bg-slate-100 rounded-md shadow-md p-4 ">
          ...
          />
          <label htmlFor="special" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-aria-disabled:opacity-70">
          Caracteres: !@#$%
          </label>
