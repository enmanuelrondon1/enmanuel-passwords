...
import { formSchema } from "@/app/(routes)/(home)/components/FormAddElement/FormAddElement.form";

export const FormEditElement = (props: FormEditElementProps) => {
    ...
    <Form {...form}>
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Quieres seleccionar tu contraseña favorita?</FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>QDirectorio</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger>
        ...
        <div>
          <div className="text-slate-400 justify-between flex items-center text-sm">
            Autenticacion TOTP
